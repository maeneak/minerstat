"""
Custom integration to integrate Minerstat with Home Assistant.

For more details about this integration, please refer to
https://github.com/maeneak/minerstat
"""
import asyncio
import logging
...
class MinerstatDataUpdateCoordinator(DataUpdateCoordinator):
    """Class to manage fetching data from the API."""

    def __init__(
        self,
        hass: HomeAssistant,
        client: MinerstatApiClient,
    ) -> None:
        """Initialize."""
        self.api = client
        self.platforms = []
